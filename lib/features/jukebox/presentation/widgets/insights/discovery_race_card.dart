          ...
          return Container(
            ...
            child: Column(
              children: [
                ...
                Text(
                  'No shared artists with history just yet — listen together and see who discovered whom first.',
...
class _Podium extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final winnerLabel = entry.winner == 'khent'
        ? 'Khent'
        : entry.winner == 'clair'
        ? 'Clair'
        : entry.winner == 'tie'
        ? 'Tie'
        : '—';
    final winnerColor = entry.winner == 'khent'
...
class _RaceRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final winnerColor = winner == 'khent'
        ? AppColors.auroraTeal
        : winner == 'clair'
        ? AppColors.cinemaPink
        : winner == 'tie'
    ...
    final winnerText = winner == 'khent'
        ...
        ? 'Same moment ♡'
        : 'Unknown';
    final khentDate = entry.khentFirst != null
        ? DateFormat('MMM d, y').format(entry.khentFirst!)
        : '—';
    final clairDate = entry.clairFirst != null
        ? DateFormat('MMM d, y').format(entry.clairFirst!)
        : '—';
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(color: winnerColor.withValues(alpha: 0.32)),
            ),
            child: Icon(
              winner == 'khent'
