      ...
      builder: (context, insights, stats, _) {
        ...
        return Container(
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: AppColors.auroraGold.withValues(alpha: 0.18),
            ),
            boxShadow: [
              BoxShadow(
                        ...
                        Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              Text(
                                'No plays this week yet — press play and your Wrapped will bloom here.',
                              ...
                              return Column(
                                children: [
                                  _PersonWeekly(
                                    ...
                                    weeklyArtists: insights.khentWeeklyArtists
                                        .map((a) => a.name)
                                        .take(2)
                                        .join(', '),
                                  ),
                                  ...
                                  _PersonWeekly(
                                    ...
                                    weeklyArtists: insights.clairWeeklyArtists
                                        .map((a) => a.name)
                                        .take(2)
                                        .join(', '),
                                  ),
          ...
          Row(
            children: [
              ...
              Container(
                padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 4),
                decoration: BoxDecoration(
                  color: leaderColor.withValues(alpha: 0.14),
                  borderRadius: BorderRadius.circular(99),
                  border: Border.all(
                    color: leaderColor.withValues(alpha: 0.28),
                  ),
                ),
                child: Text(
                  leader.toUpperCase(),
          ...
          ClipRRect(
            ...
            child: SizedBox(
              ...
              child: Row(
                children: [
                  Expanded(
                    flex: (kf * 100).round().clamp(1, 99),
                    child: Container(color: AppColors.auroraTeal),
                  ),
                  Expanded(
                    flex: (cf * 100).round().clamp(1, 99),
                    child: Container(color: AppColors.cinemaPink),
                  ),
                ],
              ),
            ),
