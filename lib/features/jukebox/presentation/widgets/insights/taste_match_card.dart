        ...
        return Container(
          decoration: BoxDecoration(
            ...
            boxShadow: [
              ...
              BoxShadow(
                color: AppColors.auroraLilac.withValues(alpha: 0.08),
                blurRadius: 32,
                spreadRadius: -6,
              ),
            ],
            ...
            child: Stack(
              children: [
                ...
                const Positioned(
                  top: -30,
                  left: -20,
                  child: _Glow(color: AppColors.auroraRose, size: 180),
                ),
                const Positioned(
                  bottom: -40,
                  right: -30,
                  child: _Glow(color: AppColors.auroraLilac, size: 220),
                ),
                    ...
                    children: [
                          ...
                          if (isNarrow) {
                            return Column(
                              children: [
                                ...
                                _SplitColumns(
                                  khentUnique: khentUnique,
                                  clairUnique: clairUnique,
                                ),
                              ],
                            );
                          }
                      ...
                      if (shared.isEmpty && p.hasAny) ...[
                        ...
                        Container(
                          ...
                          child: Text(
                            'No shared artists in your top 50 yet — keep exploring together and your Venn will bloom.',
                            style: AppTypography.outfitMedium.copyWith(
                              fontSize: 12,
          ...
          return Stack(
            ...
            children: [
              SizedBox(
                width: 148,
                height: 148,
                child: CustomPaint(painter: _RingPainter(progress: v)),
              ),
              Container(
                width: 112,
                height: 112,
      ...
      children: [
        ...
        if (artists.isEmpty)
          ...
          Wrap(
            ...
            runSpacing: 8,
            children: artists
                .map((a) => _ArtistChip(artist: a, isShared: true))
                .toList(),
          ),
      ],
    );
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [
            ...
            AppColors.auroraGold.withValues(alpha: 0.06),
          ],
        ),
        borderRadius: BorderRadius.circular(99),
