            ...
            children: [
              Row(
                children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          isEmpty
                              ? 'No loved tracks yet'
                              : '${khent.length + clair.length} hearts collected',
                  ...
                  _FilterChip(
                    label: 'Khent',
                    selected: _filter == 'khent',
                    onTap: () => setState(() => _filter = 'khent'),
                  ),
                  const SizedBox(width: 6),
                  _FilterChip(
                    label: 'Clair',
                    selected: _filter == 'clair',
                    onTap: () => setState(() => _filter = 'clair'),
                  ),
                ],
              ),
              ...
              if (isEmpty)
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        'Love a track on Last.fm and it will bloom here as a dedication.',
                ...
                Container(
                  ...
                  child: Text(
                    '$ownerLabel hasn\'t loved anything yet — tap ♥ on Last.fm to start.',
                    style: AppTypography.outfitMedium.copyWith(
                      fontSize: 12,
                      color: AppColors.textMedium,
                    ),
                      ...
                      child: ListView.separated(
                        ...
                        itemBuilder: (context, i) {
                          ...
                          return _LovedCard(
                            track: t,
                            owner: owner,
                            onDedicate: () => _openDedicate(context, t, owner),
                          );
                        },
                      ),
                    ),
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        shape: RoundedRectangleBorder(
          borderRadius: AppRadius.radiusX2,
          side: BorderSide(color: AppColors.moonlight.withValues(alpha: 0.14)),
        ),
        title: Text(
          'Dedicate this track?',
            ...
            children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'from $owner • to ${to == 'khentsgdz' ? 'Khent' : 'Clair'}',
                          style: AppTypography.outfitBold.copyWith(
                            fontSize: 10,
                            letterSpacing: 0.8,
                            color: AppColors.blushGold,
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  hintText:
                      'Add a note (optional) — e.g. "this reminded me of you"',
                  ...
                  counterStyle: AppTypography.outfitMedium.copyWith(
                    fontSize: 10,
                    color: AppColors.textMuted,
                  ),
                ),
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            onPressed: () async {
              try {
                await _dedicationService.dedicate(
                  fromUsername: from,
                  toUsername: target,
                ...
                if (context.mounted) {
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text(
                        'Dedicated “${track.trackName}” to ${target == 'khentsgdz' ? 'Khent' : 'Clair'} ♡',
                        style: AppTypography.outfitMedium.copyWith(
                          color: AppColors.petalWhite,
                        ),
                      ),
                ...
                if (ctx.mounted) {
                  ScaffoldMessenger.of(ctx).showSnackBar(
                    SnackBar(content: Text('Could not dedicate: $e')),
                  );
                }
              }
            },
    ...
    child: Container(
      ...
      child: Text(
        ...
        style: AppTypography.outfitBold.copyWith(
          fontSize: 9,
          letterSpacing: 0.9,
          color: selected ? AppColors.auroraRose : AppColors.textMedium,
        ),
      ),
    ),
  );
