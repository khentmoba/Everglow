  ...
  Widget build(BuildContext context) {
    ...
    final headerRow = LayoutBuilder(
      builder: (context, constraints) {
        ...
        final trailing = Column(
          ...
          children: [
            if (hasTotal) _TotalListensPill(countText: formatted, isLeader: isLeader),
            if (isLeader) ...[
    ...
    return Stack(
      ...
      children: [
          ...
          child: Stack(
            children: [
              Positioned.fill(
                child: ClipRRect(
                  borderRadius: BorderRadius.circular(18),
                  child: _ChampionShimmer(color: AppColors.auroraGold),
                ),
              ),
              Padding(
        ...
        Positioned(top: -7, right: 10, child: _SparkleBadge(color: AppColors.auroraGold)),
        Positioned(top: -5, right: 32, child: _PulsingDot(color: AppColors.auroraGold, size: 5)),
        Positioned(bottom: -5, left: 18, child: _PulsingDot(color: AppColors.auroraGold, size: 3.5)),
      ],
    );
  }
}
    ...
    if (!isLeader) {
      return Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: AppColors.blushGold.withValues(alpha: 0.45), width: 1),
        ),
        child: const Icon(Icons.leaderboard_rounded, size: 18, color: AppColors.blushGold),
      );
    }
    return Container(
      width: 42,
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(color: AppColors.auroraGold.withValues(alpha: 0.55), blurRadius: 16, offset: const Offset(0, 4)),
        ],
      ),
      child: const Icon(Icons.emoji_events_rounded, size: 20, color: Color(0xFF6B4E00)),
    );
  }
}
...
class _HeaderCrownSparkleState extends State<_HeaderCrownSparkle> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return FadeTransition(
      opacity: Tween<double>(begin: 0.55, end: 1).animate(CurvedAnimation(parent: _c, curve: Curves.easeInOut)),
      child: ScaleTransition(
        scale: Tween<double>(begin: 0.9, end: 1.1).animate(CurvedAnimation(parent: _c, curve: Curves.easeInOut)),
        child: const Icon(Icons.auto_awesome_rounded, size: 14, color: AppColors.auroraGold),
      ),
    );
  }
}
  ...
  Widget build(BuildContext context) {
    if (isLeader) {
      return Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: AppColors.auroraGold.withValues(alpha: 0.48), width: 1),
          boxShadow: [
            BoxShadow(color: AppColors.auroraGold.withValues(alpha: 0.20), blurRadius: 12),
          ],
        ),
        child: Row(
          mainAxisSize: MainAxisSize.min,
          children: [
            const Icon(Icons.headset_rounded, size: 12, color: AppColors.auroraGold),
            ...
            Text(
              ...
              style: AppTypography.outfitBold.copyWith(
                ...
                shadows: [Shadow(color: AppColors.auroraGold.withValues(alpha: 0.30), blurRadius: 8)],
              ),
            ),
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(99),
        border: Border.all(color: AppColors.moonlight.withValues(alpha: 0.18), width: 1),
      ),
      child: Row(
        mainAxisSize: MainAxisSize.min,
        children: [
          Icon(Icons.headset_rounded, size: 12, color: AppColors.blushGold.withValues(alpha: 0.9)),
          const SizedBox(width: 5),
          Text(
            countText,
            style: AppTypography.outfitBold.copyWith(fontSize: 12, height: 1, color: AppColors.petalWhite),
          ),
          const SizedBox(width: 4),
          Text(
            'listens',
...
class _ChampionBadgeState extends State<_ChampionBadge> with SingleTickerProviderStateMixin {
        ...
        return Transform.scale(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(99),
              border: Border.all(color: Colors.white.withValues(alpha: 0.78), width: 1.1),
              boxShadow: [
                BoxShadow(color: AppColors.auroraGold.withValues(alpha: glow), blurRadius: 16, offset: const Offset(0, 3)),
                BoxShadow(color: AppColors.inkDeep.withValues(alpha: 0.28), blurRadius: 8),
              ],
            ),
            child: child,
          ),
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: const Color(0xFF6B4E00).withValues(alpha: 0.22)),
                ),
                child: const Icon(Icons.emoji_events_rounded, size: 10, color: Color(0xFF6B4E00)),
              ),
              const SizedBox(width: 5),
              Text(
                '1ST',
              ...
              const Icon(Icons.auto_awesome_rounded, size: 9, color: Color(0xFF6B4E00)),
            ],
          ),
...
class _ChampionBadgeShimmerState extends State<_ChampionBadgeShimmer> with SingleTickerProviderStateMixin {
  late final AnimationController _c;
  ...
  void initState() {
    ...
    _a = Tween<double>(begin: -1.2, end: 1.6).animate(CurvedAnimation(parent: _c, curve: Curves.easeInOut));
  }
...
class _ChampionShimmerState extends State<_ChampionShimmer> with SingleTickerProviderStateMixin {
  late final AnimationController _c;
  late final Animation<double> _a;
  @override
  void initState() {
    ...
    _a = Tween<double>(begin: -1.2, end: 1.8).animate(CurvedAnimation(parent: _c, curve: Curves.easeInOut));
  }
...
class _PulsingDotState extends State<_PulsingDot> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return FadeTransition(
      ...
      child: ScaleTransition(
        scale: Tween<double>(begin: 0.75, end: 1.15).animate(CurvedAnimation(parent: _c, curve: Curves.easeInOut)),
        child: Container(
          width: widget.size,
          height: widget.size,
          decoration: BoxDecoration(
            shape: BoxShape.circle,
            color: widget.color,
            boxShadow: [BoxShadow(color: widget.color.withValues(alpha: 0.55), blurRadius: 8)],
          ),
        ),
      ),
    );
