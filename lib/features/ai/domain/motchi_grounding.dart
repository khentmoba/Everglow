/// Pure response-grounding helpers for Motchi (Phase 4 validation).
///
...
class MotchiGrounding {
  const MotchiGrounding();
  ...
  /// watchlist title lookup (`titlesMatch` in `functions/motchi_tools.js`).
