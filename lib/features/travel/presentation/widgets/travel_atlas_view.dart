              ...
              child: Column(
                ...
                children: [
                  Icon(
                    ...
                    size: 48,
                    color: AppColors.auroraTeal.withValues(alpha: 0.6),
                  ),
              ...
              child: Container(
                ...
                child: ClipRRect(
                  ...
                  child: Stack(
                    children: [
                      Positioned.fill(
                        child: CustomPaint(painter: _AtlasGridPainter()),
                      ),
                      ...pins.map((p) {
    ...
    return Column(
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            color: pin.isVisited ? AppColors.success : AppColors.deepRose,
