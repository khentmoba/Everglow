...
class _GatewayPageState extends State<GatewayPage> {
  ...
  Future<void> _seedDataOnce() async {
    try {
      ...
      await seedIfMissing(
        "Puting Bato x Zackie's Restaurant Date",
        Milestone(
          id: '',
