              ...
              builder: (context, snap) {
                ...
                return Column(
                  children: [
                    EverglowFeatureHeader(
                      title: page.title,
                      subtitle: '${page.wordCount} words • by ${page.author}',
                            ...
                            Container(
                              ...
                              child: SelectableText(
                                page.markdown.isEmpty
                                    ? 'No content yet — tap edit to write your lore ✨'
                                    : page.markdown,
                                style: AppTypography.outfitWhite.copyWith(
                                  fontSize: 14,
                                  height: 1.6,
...
extension _PageCopy on WikiPage {
  WikiPage copyWith({String? title, String? markdown, int? wordCount}) =>
      WikiPage(
        id: id,
        bookId: bookId,
