            ...
            child: Column(
              children: [
                EverglowFeatureHeader(
                  title: 'Chess',
                  subtitle: 'Lila • synced via Firestore',
                    ...
                    child: Row(
                      children: [
                        Container(
                          ...
                          height: 8,
                          decoration: BoxDecoration(
                            color: _turn == 'w' ? Colors.white : Colors.black,
                            shape: BoxShape.circle,
                            border: Border.all(color: AppColors.blushGold),
                          ),
                        ),
                                ...
                                child: Container(
                                  ...
                                  child: Center(
                                    child: Text(
                                      ...
                                      style: TextStyle(
                                        fontSize: 26,
                                        color: piece != null && _isWhite(piece)
                                            ? Colors.white
                                            : Colors.black,
                                        shadows: [
                                          Shadow(
