# Motchi System Prompt — v1 snapshot (2026-09-03)

> Versioned snapshot of the live prompt built in `index.js`
> (`systemPrompt` fallback + `MOTCHI_TOOLS`, ~line 1355+ and ~line 1589+).
...
>
> Bump to `motchi_prompt_v2.md` (and update `eval_gate.js`
