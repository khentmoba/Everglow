# Motchi System Prompt — v3 snapshot (2026-09-16)
...
>
> v3 changes vs v2: the fallback persona's static 50-tool list is now
> rendered per request from the attached tools (`toolListSection`:
> names only, full descriptions ride with the schemas; a no-tools
> note when routing attaches nothing). Bump to `motchi_prompt_v4.md`
