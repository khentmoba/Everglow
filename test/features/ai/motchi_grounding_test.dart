import 'package:everglow/features/ai/domain/motchi_grounding.dart';
import 'package:flutter_test/flutter_test.dart';

void main() {
  const grounding = MotchiGrounding();

  group('MotchiGrounding.extractTitles', () {
  ...
  group('MotchiGrounding.titlesMatch', () {
  ...
  group('MotchiGrounding.findUnknownTitles', () {
