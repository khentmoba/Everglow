import 'package:everglow/features/ai/domain/motchi_quality.dart';
import 'package:flutter_test/flutter_test.dart';

void main() {
  const quality = MotchiQuality();
  const selector = ContextSelector();

  group('MotchiQuality.shouldAutoThink', () {
    test('short casual messages stay on the fast path', () {
      expect(quality.shouldAutoThink('hi motchi'), isFalse);
