...
- Every PR shows proof: attach a screenshot of just the changed screen, and check the auto-posted preview link (alive 12 hours). Repo is public, so never screenshot logged-in couple-only pages.
